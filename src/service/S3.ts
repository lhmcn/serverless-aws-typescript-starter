...
const putFile = async (Key: string, Body: Buffer | NodeJS.WritableStream): Promise<S3.PutObjectOutput> => {
...
const copyFile = async (sourceKey: string, destinationKey: string): Promise<S3.CopyObjectOutput> => {
