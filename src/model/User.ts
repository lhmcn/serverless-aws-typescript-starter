...
export default class User {
	 ...
	 */
	static async changePassword(Username: string, Password: string, Permanent: boolean = false): Promise<void> {
	 ...
	 * @private
	 */
	private static async listUsersInGroup(GroupName: string, NextToken: string = undefined): Promise<ListUsersInGroupResponse> {
	 ...
	 * @param GroupName
	 */
	static async removeGroup(Username: string, GroupName: string): Promise<void> {
